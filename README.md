# Two Buttons, One Feed: Aligning YouTube Recommendations Requires Both 'Like' and 'Not Interested'

Data and analysis code for a controlled simulated user audit of YouTube's explicit
